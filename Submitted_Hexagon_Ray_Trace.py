# -*- coding: utf-8 -*-
"""
Created on Thu Mar 26 08:14:15 2026
...
num_angles = 360
num_rot = 1000
max_bounces = 5   #  USER CONTROL: number of internal reflections
...
plt.xlabel('Scattering Angle [\u00b0]')
plt.ylabel('Degree of Linear Polarization (-P12/P11)')
